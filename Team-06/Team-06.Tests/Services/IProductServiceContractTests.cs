...
namespace Team_06.Tests.Services
{
    /// <summary>
    ...
    public class IProductServiceContractTests
    {
        ...
        public void GetProductsAsync_ShouldHaveCorrectSignature()
        {
            ...
            method!.ReturnType.Should().Be(typeof(Task<List<Team_06.Data.DTOs.ProductDto>>));
        ...
        public void GetProductByIdAsync_ShouldHaveCorrectSignature()
        {
            ...
            // Assert
            method.Should().NotBeNull();
            method!.ReturnType.Should().Be(typeof(Task<Team_06.Data.DTOs.ProductDto?>));
        ...
        public void Interface_ShouldBeInCorrectNamespace()
        {
            ...
            // Assert
            interfaceType.Namespace.Should().Be("Team_06.Services.Interfaces");
        }
